...
(defvar org-agenda-kanban-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map "t" #'org-agenda-kanban-set-todo)
    ...
    (define-key map "/t" #'org-agenda-kanban-toggle-tag)
    (define-key map "/+" #'org-agenda-kanban-include-tag)
    (define-key map "/-" #'org-agenda-kanban-exclude-tag)
    (define-key map "/r" #'org-agenda-kanban-remove-tag)
    (define-key map "/p" #'org-agenda-kanban-filter-by-priority)
